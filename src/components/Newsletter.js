...
const Newsletter = () => {
  return (
    <div className="my-12">
      ...
      <div className="mt-12">
        <div className="flex overflow-hidden bg-subMain border rounded ">
          <input
            type="email"
            className="bg-subMain w-4/6 md:w-5/6 px-6 sm:py-5 py-3 text-black placeholder:text-black"
            placeholder="E-mail"
          />
